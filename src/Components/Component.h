...
public:
	...
	ShapeType shapeType;				// 物理形状类型（"circle", "box", "polygon"）
	...
	void DrawColliderOutline(void* drawList, float windowWidth, float windowHeight, float viewScale, uint32_t color) const;
	void DrawColliderOutlineRecursive(void* drawList, float windowWidth, float windowHeight, float viewScale, uint32_t color) const;
